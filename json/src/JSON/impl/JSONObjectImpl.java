 ...
 * </p>
 * <ul>
 *   <li>{@link JSON.impl.JSONObjectImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JSONObjectImpl extends JSONElementImpl implements JSONObject {
	...
	public EList<JSONProperty> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<JSONProperty>(JSONProperty.class, this, JSONPackage.JSON_OBJECT__PROPERTIES);
		}
		return properties;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JSONPackage.JSON_OBJECT__PROPERTIES:
